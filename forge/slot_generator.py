...
# def generate_meeting_slots(phase: Phase) -> list[Event]:
#     """
#     Generate a list of Event objects for all weekday meeting slots in a phase.

#     Args:
#         phase: Tuple (phase_name, phase_start_date, phase_end_date, phase_emoji)

#     Returns:
#         List of Event objects, one per city/time slot per weekday.
#     """
#     # phase.name, phase.start, phase.end, phase.emoji = phase
#     events = []
...
# def generate_meeting_slots(phase: Phase) -> list[Event]:
#     """
#     Generate a list of Event objects for all weekday meeting slots in a given Phase.

#     Args:
#         phase (Phase): A structured Phase object with name, start, end, and emoji.

#     Returns:
#         List[Event]: Calendar events for each eligible meeting slot.
#     """
#     events = []
#     current_date = phase.start
...
#                 slot_index = get_slot_index_for_time(start_dt)
#                 emoji, face_name = get_emoji_name_for_slot(slot_index)
#                 summary = f"{city} {emoji} {face_name} Slot ({local_desc})"
#                 description = f"{phase.emoji} — {phase.name}"
